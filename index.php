...
<div id="wrapper">
		...
		<div class="innerContent">
			...
			<div class="container clearfix">
				...
				<div class="two-thirds column contactForm">
					...
					<p>お気軽にお声がけください。</p>														
					<div class="cForm">
						<form id="mailForm" method="post" action="send.php">
							<p>
							...
							<div id="submit" class="regButton"  onclick="submitMailForm()"><i class="icon-mail"></i>Send message</div>
						</form>
	...
	<!--Contact section-->
	<section id="login" class="offset section">
		<!--Inner content-->
		<div class="innerContent">
			<!--Container-->
			<div class="container clearfix">
				<div class="sixteen columns">
					<h1 class="titleBig">login</h1>
				</div>											
				<div class="one-third column info">
					<h2>Recruit</h2>
					<ul class="workHours">
						<li>撮影現場のお手伝いを募集しております</li>
						<li>閲覧にはログインが必要です</li>

						<li><span>　管理用：test1 / test1</span></li>
						<li><span>　一般用：test2 / test2</span></li>
					</ul>
				</div>											
				<div class="two-thirds column contactForm">													
					<div class="cForm">
						<form id="loginForm" method="post" action="login_act.php">
							<p>
								<label for="name">ID <span class="required">*</span></label>
								<input type="text" name="lid" id="lid">
							</p>
							<p>
								<label for="name">PW <span class="required">*</span></label>
								<input type="text" name="lpw" id="lpw">
							</p>
							<div id="submit" class="regButton"  onclick="submitLoginForm()">Submit</div>
						</form>
					</div>																												
				</div>																																	
			</div>
